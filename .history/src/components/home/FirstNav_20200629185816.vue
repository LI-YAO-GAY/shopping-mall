      ...
      <div class="main_left">
        ...
        <div>
          <div v-if="flag === true" class="history">
            ...
            <div>搜索历史</div>
            <div @click="clearAll"><van-icon name="delete" size="20px"/></div>
            </div>
            <div class="flex f-w">
          ...
          <div class="list" v-if="flag===false">
            <div v-for="(item,index) in list" :key="index">
              <!-- 关键字高亮-->
              <div class="list-item p-tb-10 bg-fff p-l-10" v-html="name(item.name,value)" @click="searchHistoryDetails(item)"></div>
            </div>
          </div>
        </div>
      </div>
