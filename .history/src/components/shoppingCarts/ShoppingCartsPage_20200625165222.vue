      ...
      <van-panel>
        <template #header>
          <div class="flex j-between p-tb-10">
            <van-checkbox v-if="flag===true" shape="square" class="m-l-10" @click="changeAll">全选</van-checkbox>
            <van-checkbox v-if="flag===false" shape="square" class="m-l-10" @click="toggleAll">反选</van-checkbox>
