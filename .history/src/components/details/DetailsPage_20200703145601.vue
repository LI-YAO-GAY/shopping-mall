<template>
  <div>
      ...
      <div class="main flex a-column">
        ...
        <div v-if="activeName === 'b'">
          <div>
            ...
            <div class="F16 p-tb-20 flex a-center j-center null" v-if="evaluateItem.length===0">亲，暂无评价~~</div>
          </div>
        </div>
      </div>
    </div>
    <van-goods-action>
      ...
      <van-goods-action-icon icon="shop-o" text="购物车" @click="check" :badge="shopList.length"  v-if="shopList.length>0"/>
