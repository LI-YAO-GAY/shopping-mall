  ...
  <div>
    ...
    <div class="wrapper" ref="wrapper">
      <div class="main flex a-column">
        <div class="relative">
          <div>
            <van-swipe :autoplay="3000" initial-swipe="0" :stop-propagation="false">
              <van-swipe-item>
                <img :src="obj.image" alt class="w100p" @click="lookImg(obj.image)"/>
              </van-swipe-item>
              <van-swipe-item>
                <img :src="obj.image_path" alt class="w100p" @click="lookImg(obj.image)"/>
              </van-swipe-item>
            </van-swipe>
          </div>
        ...
        <div v-html="obj.detail" v-if="activeName === 'a'" class="detailsItem"></div>
        <div v-if="activeName === 'b'">
          <div>
              ...
              <van-card class="relative">
                ...
                <template #title>
                  <div class="flex a-center j-between m-t-20">
                    ...
                    <div
                      class="F16 m-l-10"
                      v-if="item3.anonymous===false"
                    >{{user.userInfo.nickname}}</div>
            ...
            <div
              class="F16 p-tb-20 flex a-center j-center null"
              v-if="evaluateItem.length===0"
            >亲，暂无评价~~</div>
          </div>
        </div>
      </div>
    ...
    <van-goods-action>
      ...
      />
      <van-goods-action-icon icon="shop-o" text="购物车" @click="check" v-if="shopList.length===0" />
