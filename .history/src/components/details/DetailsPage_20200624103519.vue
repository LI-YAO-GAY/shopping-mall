<template>
  <div>
    ...
    <van-popup v-model="show" closeable round position="bottom" :title="obj.name">
    <div class="content">
      <div class="flex">
        <div class="popup-img">
          <img :src="obj.image" alt class="w100ps" />
        </div>
        <div>
          <div class="m-t-40">{{obj.name}}</div>
          <div class="color-red m-tb-5">￥{{obj.orl_price}}</div>
        </div>
      </div>
      <div class="flex a-center second">
        <div>
