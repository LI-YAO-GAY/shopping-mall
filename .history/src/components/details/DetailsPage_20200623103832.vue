  ...
  <div>
    <div class="main flex a-column">
      ...
      <div class="flex goods m-t-20 j-around">
        <div v-for="(item,index) in goodsXP" :key="index" class="p-tb-5">{{item.name}}
        </div>
        <div :class="{'red':num === index}"></div>
        <!-- <div class="p-tb-5" @click="detail" :class="{'red':num === index}">商品详情</div>
        <div class="p-tb-5" @click="evaluate" :class="{'red':num === index}">商品评论</div>-->
      </div>
      <van-goods-action>
