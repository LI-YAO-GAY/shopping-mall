    ...
    <div class="tab" ref="tab">
        ...
        <div class="flex main-bottom">
            ...
            <div class="flex right" v-if="categorydata.length>0">
                        ...
                        <van-tab v-for="(item1,index1) in categorydata[0].bxMallSubDto" :key="index1"  v-model="active" swipeable @click="onClick">
                            <van-tab :title="item1.mallSubName" v-for="(item,index) in dataList" :key="index"></van-tab>
                        </van-tab>
