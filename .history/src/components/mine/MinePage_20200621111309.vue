<template>
  <div>
    <div class="main">
      ...
      <div>
      <van-tabbar >
  <van-tabbar-item icon="home-o" fixed=false  >标签</van-tabbar-item>
  <van-tabbar-item icon="search" fixed=false  dot>标签</van-tabbar-item>
  <van-tabbar-item icon="friends-o" fixed=false  badge="5">标签</van-tabbar-item>
  <van-tabbar-item icon="setting-o" fixed=false  badge="20">标签</van-tabbar-item>
</van-tabbar>
      </div>

      <div class="flex a-center j-between p-tb-15 p-lr-10 all">
        <div class="flex a-center">
          <van-icon name="records" class="m-r-5" />全部订单
        </div>
        <van-icon name="arrow" />
      </div>
      <div class="flex a-center j-between p-tb-15 p-lr-10 all m-t-20">
        <div class="flex a-center">
