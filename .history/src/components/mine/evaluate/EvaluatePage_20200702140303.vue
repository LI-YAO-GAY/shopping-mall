    ...
    <van-pull-refresh v-model="isLoading" @refresh="onRefresh" success-text="刷新成功">
      ...
      <div class="flex j-center">
        <div class="nav flex a-center j-around relative">
          ...
          <van-tab title="待评价" name="a"  @click="beforeEvalute"><an-tab>
          <van-tab title="已评价" name="b"  @click="afterEvalute"><an-tab>
        <van-tabs>
        </div>
      </div>
      <div v-if="flag === true" class="bottom">
      ...
      <div v-if="flag === false" class="bottom">
