        ...
        <div class="center">
          <div class="banner flex a-column a-center j-center">
            ...
            <van-image
              ...
              class="m-t-30"
            />
            <div class="m-tb-10 F18 fw-600 color-999" v-if="userInfo!==null && userPersonal===null">欢迎您:{{userInfo.nickname}}</div>
            <!-- <div class="m-tb-10 F18 fw-600 color-999" v-if="userPersonal">欢迎您:{{userPersonal.nickname}}</div> -->
...
export default {
  ...
  mounted() {
    ...
    if (localStorage.personal) {
      this.userPersonal = JSON.parse(localStorage.getItem("personal"));
