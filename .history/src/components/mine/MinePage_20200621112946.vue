    ...
    <div class="main">
      ...
      <div>
        <van-grid :column-num="5" :border="false">
          ...
          <van-grid-item icon="like-o" text="已完成" badge="99+" />
        </van-grid>
      </div>

      <div class="flex a-center j-between p-10 F14 all">
        <div class="flex a-center">
          <van-icon name="records" class="m-r-5 F18" />全部订单
        </div>
        <van-icon name="arrow" />
      </div>
      <div class="flex a-center j-between p-10 F14 all m-t-20">
        <div class="flex a-center">
          <van-icon name="star-o" class="m-r-5 F18" />收藏商品
        </div>
        <van-icon name="arrow" />
      </div>
      <div class="flex a-center j-between p-10 F14 all">
        <div class="flex a-center">
          <van-icon name="location-o" class="m-r-5 F18" />地址管理
        </div>
        <van-icon name="arrow" />
      </div>
      <div class="flex a-center j-between p-10 F14 all">
        <div class="flex a-center">
          <van-icon name="eye-o" class="m-r-5 F18" />最近浏览
        </div>
        <van-icon name="arrow" />
      </div>
    </div>
