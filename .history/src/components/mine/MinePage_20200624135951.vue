    ...
    <div class="main">
      ...
      <div class="banner flex a-column a-center j-center">
        <van-image
          ...
          class="m-t-30"
        />
        <div class="m-tb-10 F20 fw-600 color-666">欢迎您:{{nickname}}</div>
        <div class="m-b-30 F14 color-666">
          <div v-if="flag === false" @click="quit">退出登录</div>
          <div v-if="flag === true" @click="login">未登录</div>
        </div>
      </div>
