<template>
  <div>
    ...
    <div class="main">
      <van-tabs v-model="activeName" swipeable sticky swipe-threshold="5">
        <van-tab title="全部" name="a"></van-tab>
        <van-tab title="待支付"></van-tab>
        <van-tab title="待发货"></van-tab>
        <van-tab title="待收货"></van-tab>
        <van-tab title="已完成" name="b"></van-tab>
      </van-tabs>
      <div v-if="activeName ==='a'">
        <van-pull-refresh v-model="isLoading" @refresh="onRefresh" success-text="刷新成功">
          <div class="content m-lr-10">
      ...
      <div v-if="activeName ==='b'">
        <van-pull-refresh v-model="isLoading" @refresh="onRefresh" success-text="刷新成功">
          <div class="content m-lr-10 m-t-10">
            <div v-for="(item,index) in list" :key="index">
              <div class="border m-b-10">
                <van-cell-group>
                  <van-cell>
