        ...
        <van-tab v-for="(item,index) in navList" :key="index" :title="item.name" ellipsis="false">
          <div class="content p-10">
            <div v-for="(item,index) in list" :key="index">
              <div class="border m-b-10 relative">
                <van-cell-group>
                  <van-cell value="交易完成">
                    <template #title>
                    ...
                    <template #label>
                      <div v-for="(item1,index1) in item.order_list" :key="index1">
                        <div class="flex">
                          ...
                          <div class="flex a-center desc m-t-10">
                            <div class="color-333 F14 m-l-10 name">{{item1.name}}</div>
                            <div class="color-333 m-l-10 F14 price">￥{{item1.mallPrice}}</div>
                          </div>
                        </div>
                      </div>
