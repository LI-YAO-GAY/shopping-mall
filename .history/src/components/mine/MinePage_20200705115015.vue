      ...
      <van-pull-refresh v-model="isLoading" @refresh="onRefresh" success-text="刷新成功">
        <div class="center">
          <div class="banner flex a-column a-center j-center">
            ...
            />
            <div>
             <div class="m-tb-10 F18 fw-600 color-999" v-if="userInfoChange">欢迎您:{{userInfoChange.nickname}}</div>
              <div class="m-tb-10 F18 fw-600 color-999" v-else>欢迎您:{{user.userInfo.nickname}}</div>
            </div>
