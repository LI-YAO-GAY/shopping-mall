<template>
  <div>
    ...
    <van-field v-model="nickname" name="性别" label="性别" placeholder="性别" />
    <van-field v-model="email" name="性别" label="性别" placeholder="性别" />
    <van-field v-model="date" name="性别" label="性别" placeholder="性别" />
  </div>
</template>
