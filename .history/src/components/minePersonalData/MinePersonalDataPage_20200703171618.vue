    ...
    conserve() {
      this.$api
        ...
        .then(res => {
          ...
          res.user={}
          this.$set(res.user, "gender", this.sex);
          this.$set(res.user, "year", this.year);
          this.$set(res.user, "month", this.month);
          this.$set(res.user, "day", this.day);
          this.$set(res.user, "id", this.id);
          this.$set(res.user, "nickname", this.nickname);
