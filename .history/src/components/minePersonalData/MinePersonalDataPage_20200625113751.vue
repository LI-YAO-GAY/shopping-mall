...
export default {
  ...
  methods: {
    ...
    conserve() {
      this.$api
        .getQueryUser({gender:this.gender, year:this.year, month:this.month, day:this.day, id:this.id,nickname :this.nickname})
        .then(res => {
          console.log(res);
          // this.currentUser = res.userInfo
          // gender=this.currentUser.gender//性别
          // year=this.currentUser.year   //年
          // month=this.currentUser.month  //月
          // day=this.currentUser.day     //日
          // id=this.currentUser.id     //用户id
          // nickname=this.currentUser.nickname //昵称
          // this.currentUser.gender=this.gender//性别
          // this.currentUser.year=this.year   //年
          // this.currentUser.month=this.month  //月
          // this.currentUser.day=this.day      //日
          // this.currentUser.id=this.id       //用户id
          // this.currentUser.nickname=this.nickname  //昵称
