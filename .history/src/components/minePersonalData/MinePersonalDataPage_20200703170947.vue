    ...
    conserve() {
      this.$api
        ...
        .then(res => {
          ...
          // this.userInfo.year = this.year
          // this.userInfo.month = this.month
          // this.userInfo.day = this.day
          // this.userInfo.id = this.id
          // this.userInfo.nickname = this.nickname
          this.$set(this.user,'gender',this.sex)
          this.$set(this.user,'year',this.year)
          this.$set(this.user,'month',this.month)
          this.$set(this.user,'day',this.day)
          this.$set(this.user,'id',this.id)
          this.$set(this.user,'nickname',this.nickname)
          // localStorage.setItem('user',this.sex,this.year,this.month,this.day,this.nickname)
          this.$router.back()
        })
        .catch(err => {
          Toast("保存失败");
