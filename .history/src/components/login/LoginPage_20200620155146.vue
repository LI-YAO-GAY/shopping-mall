  ...
  <div>
    <div class="main relative flex j-center">
      <div class="content absolute">
        ...
        这里:GO="GO"这个是啥？不是应该这样写 吗  @click = "gotologin" 因为本来它自带了一个点击事件，这个shi
...
export default {
  ...
  methods: {
    ...
    GO() {
      this.$api.getLogin({nickname: this.username,password: this.password,verify: this.verify}.then(res => {
            console.log(res);
          })
          .catch(err => {
            console.log(err);
