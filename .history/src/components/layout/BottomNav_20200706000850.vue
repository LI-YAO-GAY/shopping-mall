<template>
  <div>
    <div class="flex j-around a-center nav bg-fff relative">
      ...
      <div class="circle flex a-center j-center" v-if="count===0&&user===null">
        <div class="F14 color-fff">{{}}</div>
      </div>
      <div class="circle flex a-center j-center" v-if="count!==0">
        <div class="F14 color-fff">{{count}}</div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    addCount() {
      //  console.log(this.$store.state.addCount);
