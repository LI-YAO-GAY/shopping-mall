<template>
  <div>
    ...
    <van-submit-bar :price="total" button-text="提交订单" @submit="onSubmit" v-if="this.$route.query.arr" />
    <van-submit-bar :price="total1" button-text="提交订单" @submit="onDetail" v-if="this.$route.query.arr1" />
  </div>
</template>
