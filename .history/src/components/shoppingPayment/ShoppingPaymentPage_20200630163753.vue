  ...
  mounted() {
    ...
    this.$api
      ...
      .then(res => {
        ...
        localStorage.setItem('paymentGoods',JSON.stringify(this.arr))
        // this.arr=JSON.parse(localStorage.getItem('paymentGoods'))
        console.log(this.arr);
         this.arr=localStorage.getItem('paymentGoods')
      })
      .catch(err => {
        console.log(err);
      });
